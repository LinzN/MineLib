package de.linzn.mineLib.title;
...
public class MineTitle {
    ...
    /**
     * Constructs a {@link MineTitle} object.
     *
     ...
     */
    public MineTitle(String title, String subtitle, int fadeIn, int stay, int fadeOut) {
     ...
     * @param fadeOut  The fade-out time of the title, in ticks.
     */
    public MineTitle(JSONObject title, JSONObject subtitle, int fadeIn, int fadeOut, int stay) {
        this.title = title;
