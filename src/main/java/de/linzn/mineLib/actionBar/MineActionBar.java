package de.linzn.mineLib.actionBar;


import com.google.common.base.Preconditions;
import de.linzn.mineLib.ServerPackage;
...
public class MineActionBar {
    ...
    /**
     * Constructs an {@link MineActionBar} object based on plain text.
     *
     * @param text Text to display.
     */
    public MineActionBar(String text) {
        Preconditions.checkNotNull(text);
        this.json = convert(text);
    }

    /**
     * Constructs an {@link MineActionBar} object based on JSON-formatted text.
     *
     * @param json Text to display Must be in /tellraw JSON format.
     */
    public MineActionBar(JSONObject json) {
     ...
     * @deprecated Please create a new {@link MineActionBar} instance instead.
     */
    @Deprecated
    public static void send(Player player, String message) {
        new MineActionBar(message).send(player);
    }
    ...
    public static void sendToAll(String message) {
        new MineActionBar(message).sendToAll();
    }
